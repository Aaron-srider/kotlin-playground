...
import fit.wenchao.kotlinplayground.utils.ClassUtils;
...
public class GlobalExceptionHandler {
    ...
    public JsonResult otherException(HttpServletResponse req, Exception ex) {
        log.error("Server Exception-Name:{}，Server Exception-Msg:{}", ex.getClass()
                                                                        .getTypeName(), ex.getMessage());
        ...
        jsonResult.setMsg("Server internal error occurred --> [ " + ex.getClass()
                                                                      .getTypeName() + "-->" + ex.getMessage()
                + " ]");
        return jsonResult;
    }
